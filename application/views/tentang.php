        ...
        <div class="row about_inner">
            ...
            <div class="col-lg-6">
                <div class="video_area" id="video">
                    <img class="img-fluid" src="<?= base_url('assets2/') ?>img/video-1.jpg" alt="" />
                    <a class="popup-youtube" href="https://www.youtube.com/watch?v=FZmbSq2W1hY">
                        <img src="<?= base_url('assets2/') ?>img/icon/video-icon-1.png" alt="" />
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="testi_slider owl-carousel">
                    <div class="item">
                        <div class="testi_item">
                            <img src="<?= base_url('assets2/') ?>img/testimonials/testi-3.png" alt="">
                    ...
                    <div class="item">
                        <div class="testi_item">
                            <img src="<?= base_url('assets2/') ?>img/testimonials/testi-2.png" alt="">
                    ...
                    <div class="item">
                        <div class="testi_item">
                            <img src="<?= base_url('assets2/') ?>img/testimonials/testi-1.png" alt="">
                            <h4>Diki Ramdani</h4>
                            <ul class="list">
                                <li><a href="#"><i class="fa fa-star"></i></a></li>
                                <li><a href="#"><i class="fa fa-star"></i></a></li>
