                    ...
                    <div class="main-content">
                        ...
                        <div class="row">
                                ...
                                <div class="table-responsive ">
                                    <table id="example" class="table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <?php foreach ($materi as $a) {
                                            ?>
                                                <td><?php echo $a->deskripsi_materi ?></td>
                                            <?php } ?>
                                        </tr>
                                        <tr>
                                            <th>Kelas</th>
                            ...
                            <div class="col-sm-12">
                                <div class="wrapper">
                                    <?php foreach ($materi as $a) { ?>
                                        <iframe src="<?= base_url('assets/pdf/' . $a->file_pdf); ?>" height="500px" width="90%"></iframe>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="wrapper">
                                    <video controls height="400px" width="50%">
                                        <?php foreach ($materi as $a) { ?>
                                            <source src="<?= base_url('assets/pdf/' . $a->video); ?>">
                                        <?php } ?>
                                    </video>
                                </div>
                            </div>
                                ...
                                <div class="text-justify" style="font-size: larger">
                                    <div class="col-sm-12">
                                        <ul class="list" style="color: blue">
                                            <?php foreach ($materi as $row => $value) { ?>
                                                <li><a href="<?= base_url('siswa/siswa/TestPrepare/' . $value->id_materi); ?>">Kerjakan Soal Berikut</a></li>
                                            <?php } ?>
                                            <?php foreach ($materi as $row => $value) { ?>
                                                <li><a href="<?= base_url('siswa/siswa/kumpul_tugas/' . $value->id_materi); ?>">kumpul tugas</a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                </div>
