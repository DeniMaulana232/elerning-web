                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                        ...
                                        <div class="col-lg-4 ">
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content">
                                                    <span class="info-box-text"> <?= $value->nama_mapel; ?></span>
                                                    <a href="<?= base_url('siswa/siswa/pertemuan/' . $value->id_mapel); ?>" class="small-box-footer" id="id_kelas">More info <i class="fa fa-arrow-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
                                <?php } else { ?>
                                    ...
                                    <a colspan="10" style="text-align: center; color: green;">Maaf belum ada matapelajaran di kelas ini</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
