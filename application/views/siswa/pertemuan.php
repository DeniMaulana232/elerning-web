                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <?php if ($pertemuan) { ?>
                                    <?php foreach ($pertemuan as $row => $value) { ?>
                                        <div class="col-lg-4 ">
                                            <div class="info-box">
                                                <span class="info-box-icon bg-yellow"><i class="fa fa-home"></i></span>
                                                <div class="info-box-content">
                                                    <span class="info-box-text"> Pertemuan ke-<?= $value->no_pertemuan; ?></span>
                                                    <a href="<?= base_url('siswa/siswa/materi/' . $value->id_pertemuan); ?>" class="small-box-footer" id="id_kelas">More info <i class="fa fa-arrow-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
                                <?php } else { ?>
                                    ...
                                    <a colspan="10" style="text-align: center; color: green;">Maaf pertemuan pada matapelajaran ini belum dibuka</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
