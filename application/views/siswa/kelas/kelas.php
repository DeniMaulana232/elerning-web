                                        ...
                                        <div class="col-lg-4 ">
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <a href="<?= base_url('siswa/siswa/mapel/' . $value->id_kelas); ?>" class="small-box-footer" id="id_kelas">More info <i class="fa fa-arrow-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
                                <?php } else { ?>
                                    <a colspan="10" style="text-align: center; color: green;">Maaf Kelas belum tersedia</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
