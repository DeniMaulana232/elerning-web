                            ...
                            <form action="<?= base_url('admin/guru_edit') ?>" enctype="multipart/form-data" method="post">
                                <?php foreach ($admin as $u) { ?>
                                    ...
                                    <div id="detail" class="col-md-12 bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                                        ...
                                        <p class="text-center" style="line-height: 5px;">Dibawah ini merupakan profile dari operator sekolah</p>
                                        <hr>
                                        <div class="form-group">
                                            ...
                                            <input type=" text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required name="nama" value="<?= $u->username ?>" readonly>
                                            <label for="exampleInputEmail1" class="font-weight-bold" style="font-size: 20px;">Email</label>
                                            <input type=" text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required name="nign" value="<?= $u->email ?>" readonly>
                                        </div>
