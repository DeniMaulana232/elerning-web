                                            ...
                                            <div class="table-responsive">
                                                <table id="tbl_kelas" class="table align-items-center table-flush">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            ?>
                                                                <tr class="text-center">
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a href="<?php echo site_url('admin/delete_mapel/' .  $value->id_mapel); ?>" class="btn btn-danger remove"> Delete ✖</a>
                                                                    </td>
                                                                </tr>
                                                            <?php
                                                            }
                                                        ...
                                                        <?php } else { ?>
                                                            <tr>
                                                                <th colspan="10" style="text-align: center; color: green;">Maaf dikelas ini belum ada Matapelajaran apapun.</th>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
