                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-3 ">
                            ...
                            <a href="<?= base_url('admin/tambah_kelas') ?>" class="btn btn-success">Tambah
                                Data Kelas ⭢</a>
                        </div>
                    </div>
                                                    ...
                                                    ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <td class="text-center">
                                                                <a href="<?php echo site_url('admin/update_siswa/' . $a->id_kelas); ?>" class="btn btn-info">Update ⭢</a>

                                                                <a href="<?php echo site_url('admin/delete_kelas/' . $a->id_kelas); ?>" class="btn btn-danger remove">Delete ✖</a>
                                                            </td>
