                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <div class="p-4">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Tambah Matapelajaran</h1>
                                        </div>
                                        <form class="user" method="POST" action="<?= base_url('admin/tambah_mapel') ?>">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Matapelajaran</label>
                                                <input type="text" class="form-control " id="mapel" name="mapel" placeholder="Masukan Matapelajaran" value="<?= set_value('mapel'); ?>">
                                                <?= form_error('mapel', '<small class="text-danger pl-2">', '</small>'); ?>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="kelas" name="kelas">
                                                    ...
                                                    <?php foreach ($kelas as $p) { ?>
                                                        <option value="<?= $p->id_kelas; ?>"><?php echo $p->nama_kelas; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
