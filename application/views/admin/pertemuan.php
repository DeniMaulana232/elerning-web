                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <th scope="row">
                                                        <?php echo $p->id_pertemuan ?>
                                                    </th>
                                                    <th>
                                                        <a href="<?= base_url('admin/detail_pertemuan'); ?>"><i class="fa fa-dashboard"></i>Pertemuan <?php echo $this->db->count_all('pertemuan'); ?></a>
                                                    </th>

                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/update_pertemuan/' . $p->id_pertemuan); ?>" class="btn btn-danger remove">Delete X</a>
                                                    </td>
