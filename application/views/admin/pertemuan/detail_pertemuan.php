                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="nama_mapel" name="nama_mapel">
                            <?php foreach ($kelas as $m) { ?>
                                <option> <?php echo $m->nama_kelas; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                <div class="modal-footer">
                    <a href="<?php echo site_url('admin/tambah_pertemuan/' . $a->id_kelas); ?>" class="btn btn-info">Tampilkan ⭢</a>
