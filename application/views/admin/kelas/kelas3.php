                                    ...
                                    <div class="col-lg-4 ">
                                        <div class="info-box">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"> <?= $value->nama_kelas; ?></span>
                                                <a href="<?= base_url('admin/isi_pertemuan/' . $value->id_kelas); ?>" class="small-box-footer" id="id_kelas">More info <i class="fa fa-arrow-circle-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                        ...
                        <!-- <div class="col-md-3">
                            <div class="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                    <?php foreach ($jenis as $j => $value) { ?>
                                        <li> <a href="<?= base_url('admin/isi_pertemuan/' . $value->id_kelas); ?>" class="dropdown-item" id="id_kelas">
                                                <?= $value->nama_kelas; ?></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div> -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Kelas</label>
                        <form class="user" method="POST" action="<?= base_url('admin/detail_pertemuan') ?>">
