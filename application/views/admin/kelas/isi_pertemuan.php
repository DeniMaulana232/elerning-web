        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="<?= base_url('admin/tambah_pertemuan') ?>" class="btn btn-success">Tambah
                        Data Pertemuan ⭢</a>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                    <?php foreach ($jenis as $j => $value) { ?>
                                        <li> <a href="<?= base_url('admin/isi_pertemuan/' . $value->id_kelas); ?>" class="dropdown-item" id="id_kelas"> <?= $value->nama_kelas; ?></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
                                            <div class="table-responsive">
                                                <table id="tbl_kelas" class="table align-items-center table-flush">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            ?>
                                                                <tr class="text-center">
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a href="<?php echo site_url('admin/delete_pertemuan/' .  $value->id_pertemuan); ?>" class="btn btn-danger remove"> Delete ✖</a>
                                                                    </td>
                                                                </tr>
                                                            <?php
                                                            }
                                                        ...
                                                        <?php } else { ?>
                                                            <tr>
                                                                <th colspan="10" style="text-align: center; color: green;">Maaf Pertemuan Belum ditambah!</th>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
