                        ...
                        <section class="section">
                            <div class="card" style="width:100%;">
                                <div class="card-body">
                                    ...
                                    <a href="<?= base_url('admin/tambahguru') ?>" class="btn btn-success">Tambah
                                        Data Guru ⭢</a>
                                </div>
                            </div>
                                                        ...
                                                        ?>
                                                            <tr class="text-center">
                                                                ...
                                                                <td class="text-center">
                                                                    <a href="<?php echo site_url('admin/update_guru/' . $u->id_guru); ?>" class="btn btn-info">Update ⭢</a>

                                                                    <a href="<?php echo site_url('admin/delete_guru/' . $u->id_guru); ?>" class="btn btn-danger remove">Delete ✖</a>
                                                                </td>
