    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="<?= base_url('siswa/authuser') ?>">Untuk Siswa</a></li>
                        <li><a href="<?= base_url('guru/authguru') ?>">Untuk Guru</a></li>
                        <li><a href="<?= base_url('Auth') ?>">Untuk Admin</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="javaScript:void(0);">IPS</a></li>
                        <li><a href="javaScript:void(0);">Kewarganegaraan</a></li>
                        <li><a href="javaScript:void(0);">Seni Budaya</a></li>
                        <li><a href="javaScript:void(0);">Penjaskes</a></li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <p>
                    Web Pembelajaran Dalam Jaringan yang dibuat oleh mahasiswa Universitas Teknokrat Indonesia . Website E-learning SDN 2 Badran Sari adalah Web edukasi yang dilengkapi video, materi, tugas berupa pilihan ganda serta essai dan sistem ujian yang tersedia secara terstruktur. Website ini dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar selama masa pandemi covid-19.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> Learnify is made with <span class="text-danger"> &#10084;</span> by <a href="#">Mahasiswa Universitas Teknokrat Indonesia </a> with MIT License
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
