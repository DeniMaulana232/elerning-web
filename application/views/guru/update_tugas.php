                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="font-size: xx-large">Tambah Tugas</h6>
                        </div>
                        <?= $this->session->flashdata('message'); ?>
                        <div class="card-body">
                            <?php foreach ($edit_tugas as $row) { ?>
                                <form class="user" method="POST" action="<?= base_url('guru/guru/tugas_edit') ?>">
                                    <input type="hidden" name="id_tugas" id="id_tugas" value="<?= $row->id_tugas ?>">
                                    <div class="form-group">
                                        <label>soal</label>
                                        <?php foreach ($edit_tugas as $edit) { ?>
                                            <textarea class="form-control" rows="5" id="soal" name="soal" placeholder="ketik disini ... " value="<?= set_value('soal'); ?>">
                                    <?php } ?>
                                        <?= form_error('soal', '<small class="text-danger pl-2">', '</small>'); ?>
                                </textarea>
                                    </div>
                                    <div class="form-group">
