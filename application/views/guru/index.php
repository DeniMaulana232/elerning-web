            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-center" style="font-size: xx-large">WEB PEMBELAJARAN SDN 2 BADRAN SARI</h6>
                    </div>
                    ...
                    <div class="col-sm-8">
                        <div class="box box-solid">
                            <div class="box-header bg-purple">
                                <h3 class="box-title">Aktifitas yang dapat dilakukan</h3>
                            </div>
                            <div class="box-body">

                                <ul class="pl-4">
                                    <li><a href="<?= base_url('guru/guru/data_mapel'); ?>">Tambah Materi</a></li>
                                    <li><a href="<?= base_url('guru/guru/data_pilgan'); ?>">Upload Soal</a></li>
                                    <li><a href="<?= base_url('guru/guru/tugas_siswa'); ?>">Dokumen Tugas Siswa</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
