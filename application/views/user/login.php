                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <div class="row px-3 mb-4">
                            <small class="center">WEBSITE PEMBELAJARAN SDN 2 BADRAN SARI</small>
                            <!-- <div class="line"></div> -->
                        </div>
                        <?= $this->session->flashdata('message'); ?>
                        <form class="user" method="POST" action="<?= base_url('siswa/authuser') ?>">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="name" name="name" placeholder="Masukan Username..." value="<?= set_value('name'); ?>">
